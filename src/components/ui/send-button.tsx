...
const SendButtonBase = React.forwardRef<HTMLButtonElement, SendButtonProps>(({ isSubmitting = false, className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn("send-button-component", className, { 'is-sending': isSubmitting })}
      {...props}
    >
...
SendButtonBase.displayName = 'SendButtonBase';

export const SendButton = React.memo(SendButtonBase);
